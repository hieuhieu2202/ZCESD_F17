...
public class ESDFaceController : Controller
{
    ...
    public ActionResult ShowTestFail()
    {
    ...
    public ActionResult GetRealTimeData(string workshop, string floor)
    {
        var data = _employeeService.GetEmployeeData(workshop, floor); // Lấy dữ liệu từ MySQL
